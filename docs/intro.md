---
# 这部分是关键！侧边栏显示名由这里决定
title: 河北对口高考计算机专业高考简介  # 文档标题，若无 sidebar_label 则作为侧边栏名
sidebar_label: 河北对口高考计算机专业高考简介  # 显式指定侧边栏显示名（优先级最高）
...
等5门专业核心课程，主要测试计算机类专业考生基础知识、基本技能的掌握程度，综合运用知识、理论和方法解决实际问题的能力。
